...
| <h5>15th Nov</h5> | | <li>-[x] Meetup </li><li>-[x] Phone Number Formatting </li><li>-[x] Prime Factors </li><li>-[x] Pig Latin </li><li>-[x] Series </li><li>-[x] Ledger </li><li>-[x] Linked List </li><li>-[x] Rail Fence Cipher </li><li>-[x] Binary Search </li><li>-[x] Two Buckets </li><li>-[x] Say </li>